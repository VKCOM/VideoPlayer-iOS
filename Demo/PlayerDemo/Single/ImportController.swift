...
class ImportController: ViewController, UITextViewDelegate {
    ...
    @objc private func handleImportPasteboard() {
    ...
    @objc private func handleImportFile() {
    ...
    @objc private func handleImportVideo() {
        textView.text = "https://vk.com/video-26006257_456245181"
        didUpdateText()
    }
    
    
    @objc private func handleImportLive() {
    ...
    @objc private func handleFormatView() {
    ...
    @objc private func handleApplyButton() {
        guard let video = formatView.makeVideo() else { return }
    ...
    private func subscribeToKeyboard() {
        NotificationCenter.default.publisher(for: UIApplication.keyboardWillShowNotification)
            ...
            .sink { [unowned self] notification in
                self.updateKeyboardY(notification)
            }
