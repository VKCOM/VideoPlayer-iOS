...
target 'PlayerDemo' do
  ...
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.85/OVKResources.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.34/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.47/OVKit.podspec", :inhibit_warnings => true
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.87/OVPlayerKit.podspec", :inhibit_warnings => true
