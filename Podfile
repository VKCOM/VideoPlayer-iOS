...
target 'PlayerDemo' do
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.30/OVKit.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.68/OVKResources.podspec", :inhibit_warnings => true
  pod 'VKOpus', :podspec => "#{artifactory_url}/VKOpus/1.0/VKOpus.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.17/OVKitStatistics.podspec", :inhibit_warnings => true
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.70/OVPlayerKit.podspec", :inhibit_warnings => true
end