...
target 'PlayerDemo' do
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.53.3/OVKit.podspec", :inhibit_warnings => true
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.93.3/OVPlayerKit.podspec", :inhibit_warnings => true
  ...
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.91.3/OVKResources.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.40.3/OVKitStatistics.podspec", :inhibit_warnings => true
end