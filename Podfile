...
target 'PlayerDemo' do
  ...
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.0/OVKitStatistics.podspec", :inhibit_warnings => true
  ...
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.50/OVKResources.podspec", :inhibit_warnings => true
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.12/OVKit.podspec", :inhibit_warnings => true
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.52/OVPlayerKit.podspec", :inhibit_warnings => true
end