...
target 'PlayerDemo' do
  ...
  pod 'OVKitMyTargetPlugin', :podspec => "#{artifactory_url}/OVKitMyTargetPlugin/2.10/OVKitMyTargetPlugin.podspec", :inhibit_warnings => true
  ...
  pod 'OVKitChromecastPlugin', :podspec => "#{artifactory_url}/OVKitChromecastPlugin/1.0/OVKitChromecastPlugin.podspec", :inhibit_warnings => true
end