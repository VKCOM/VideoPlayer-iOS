...
target 'PlayerDemo' do
  ...
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.39.4/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.90.4/OVKResources.podspec", :inhibit_warnings => true
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.92.4/OVPlayerKit.podspec", :inhibit_warnings => true
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.52.4/OVKit.podspec", :inhibit_warnings => true
end