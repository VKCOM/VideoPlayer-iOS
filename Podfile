...
target 'PlayerDemo' do
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.89/OVPlayerKit.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.36/OVKitStatistics.podspec", :inhibit_warnings => true
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.49/OVKit.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.87/OVKResources.podspec", :inhibit_warnings => true
end