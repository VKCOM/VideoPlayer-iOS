...
target 'PlayerDemo' do
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.91.1/OVPlayerKit.podspec", :inhibit_warnings => true
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.51.1/OVKit.podspec", :inhibit_warnings => true
  pod 'VPX', :podspec => "#{artifactory_url}/VPX/1.2.1/VPX.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.38.1/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'Dav1d', :podspec => "#{artifactory_url}/Dav1d/2.0/Dav1d.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.89.1/OVKResources.podspec", :inhibit_warnings => true
end