...
target 'PlayerDemo' do
  ...
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.33/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.84/OVKResources.podspec", :inhibit_warnings => true
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.46/OVKit.podspec", :inhibit_warnings => true
  pod 'Dav1d', :podspec => "#{artifactory_url}/Dav1d/2.0/Dav1d.podspec", :inhibit_warnings => true
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.86/OVPlayerKit.podspec", :inhibit_warnings => true
