...
target 'PlayerDemo' do
  ...
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.5/OVKit.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.43/OVKResources.podspec", :inhibit_warnings => true
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.45/OVPlayerKit.podspec", :inhibit_warnings => true
