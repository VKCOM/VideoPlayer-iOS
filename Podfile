...
target 'PlayerDemo' do
  ...
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.90.3/OVKResources.podspec", :inhibit_warnings => true
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.92.3/OVPlayerKit.podspec", :inhibit_warnings => true
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.39.3/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.52.3/OVKit.podspec", :inhibit_warnings => true
