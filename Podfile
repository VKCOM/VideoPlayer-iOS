...
target 'PlayerDemo' do
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.59/OVPlayerKit.podspec", :inhibit_warnings => true
  ...
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.6/OVKitStatistics.podspec", :inhibit_warnings => true
  pod 'VKOpus', :podspec => "#{artifactory_url}/VKOpus/1.0/VKOpus.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.57/OVKResources.podspec", :inhibit_warnings => true
  pod 'Dav1d', :podspec => "#{artifactory_url}/Dav1d/2.0/Dav1d.podspec", :inhibit_warnings => true
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.19/OVKit.podspec", :inhibit_warnings => true
end