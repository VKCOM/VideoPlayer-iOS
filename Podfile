...
target 'PlayerDemo' do
  ...
  pod 'OVKitStatistics', :podspec => "#{artifactory_url}/OVKitStatistics/1.37/OVKitStatistics.podspec", :inhibit_warnings => true
  ...
  pod 'OVPlayerKit', :podspec => "#{artifactory_url}/OVPlayerKit/3.90/OVPlayerKit.podspec", :inhibit_warnings => true
  pod 'WebM', :podspec => "#{artifactory_url}/WebM/1.2.1/WebM.podspec", :inhibit_warnings => true
  pod 'OVKit', :podspec => "#{artifactory_url}/OVKit/5.50/OVKit.podspec", :inhibit_warnings => true
  pod 'VKOpus', :podspec => "#{artifactory_url}/VKOpus/1.0/VKOpus.podspec", :inhibit_warnings => true
  pod 'OVKResources', :podspec => "#{artifactory_url}/OVKResources/2.88/OVKResources.podspec", :inhibit_warnings => true
end